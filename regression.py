...
unique, counts = np.unique(extracted_ebb['ebb_eligible'], return_counts=True)
...
unique, counts = np.unique(y_new_set, return_counts=True)
result = np.column_stack((unique, counts)) 
print(result)
...
clf.score(new_set_df.values, y_new_set)
...
>>>>>>> 61bcb87152737b329d5c0a8c59cd86164c98f795
